...
import ChatBubbleAvatar from "./chat-bubble-avata";
...
type ChatBubbllePropsTypes = {
	message: IMessage,
	me: any,
	previousMessage?:IMessage
}

const ChatBubble = ({ me, message, previousMessage }: ChatBubbllePropsTypes) => {
	...
	<div className="flex gap-1 w-2/3 ml-auto  justify-end">
