...
type GroupMembersDialogSelectedConversation = {
	selectedConversation :Conversation
}

const GroupMembersDialog = ({ selectedConversation}: GroupMembersDialogSelectedConversation) => {
	const groupMembers = useQuery(api.users.getGroupMembers,{convesationId:selectedConversation?._id!})
	return (
		<Dialog>
			<DialogTrigger>
